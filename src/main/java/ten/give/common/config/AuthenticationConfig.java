...
import ten.give.common.filter.JwtFilter;
...
public class AuthenticationConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        return httpSecurity
                ...
                .antMatchers(HttpMethod.POST,"/api/donorcards/list","/api/users/editPassword","/view/donorcards/donorcardList","/view/donorcards").authenticated() //API 의 post 요청을 인증 필요
